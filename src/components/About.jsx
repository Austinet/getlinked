...
const About = () => {
  return (
   ...
   {/* About container */}
    <div  className="flex flex-col md:flex-row gap-[3.62rem] lg:justify-between md:items-center pt-[1.81rem] pb-[4.88rem] px-[2rem] md:pt-[3.88rem] max-w-[75rem] mx-auto">
    {/* About image */}
      <div className="px-[2.44rem] md:px-0">
        <img src={idea} alt="Light bulb" />
      </div>
      {/* About details  */}
      <div className="pl-[0.55rem] pr-[0.12rem] text-center md:text-left max-w-[33.4375rem]">
